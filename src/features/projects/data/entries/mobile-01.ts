// src/features/projects/data/entries/mobile-01.ts

import type { SingleProject } from "../singleProjectData";

const BASE = "/projects/mobile-01";

const mobile01: SingleProject = {
  id: "mobile-01", // ← MUST match the filename prefix (mobile-*)
