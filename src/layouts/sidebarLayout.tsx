...
import { useSecretClickSequence } from "../features/admin/hooks/useSecretClickSequence";
...
export default function SidebarLayout({ children }: SidebarLayoutProps) {
	...
	// Hidden admin access — tap/click the welcome text 7x within the
	// window to jump to the admin upload page. Chosen deliberately:
	// it's rendered once here in the layout, so it's reachable from
	// every page, and it's visible on mobile too (unlike the sidebar
	// or right floating bar, which are md+ only).
